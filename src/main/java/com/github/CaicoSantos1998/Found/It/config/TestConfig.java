...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2025-01-15T13:53:07Z"), u1);
        Order o2 = new Order(null, Instant.parse("2025-01-14T17:05:37Z"), u2);
        Order o3 = new Order(null, Instant.parse("2025-01-13T10:29:17Z"), u1);
